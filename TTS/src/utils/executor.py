...
from src.utils.train_utils import update_parameter_and_lr, log_per_step, log_per_save, batch_forward, batch_backward, save_model, linguifytts_join
    ...
    def train_one_epoc(self, model, optimizer, scheduler, train_data_loader, cv_data_loader, writer, info_dict, group_join):
        ...
        with model_context():
            for batch_idx, batch_dict in enumerate(train_data_loader):
                ...
                if linguifytts_join(group_join, info_dict):
                    break
