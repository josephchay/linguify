...
def main():
    with gr.Blocks() as demo:
        gr.Markdown("# LinguifySpeech")
        gr.Markdown("Agent Model: [josephchay/LinguifySpeech](https://github.com/josephchay/linguify)")

        default_text = (
            "Monoclonal antibodies have become a game-changer in medicine, especially for conditions like cancer, "
            "autoimmune diseases, and even some infections. These lab-made proteins are designed to target "
            "specific cells or substances in the body. For example, in rheumatoid arthritis, drugs like "
            "infliximab and adalimumab help reduce inflammation by blocking a protein called TNF-α. "
            "In cancer treatment, trastuzumab is commonly used to treat HER2-positive breast cancer by "
            "attaching to cancer cells and slowing their growth. Because these treatments are so targeted, "
            "they often have fewer side effects than traditional therapies, making them a powerful tool in modern healthcare."
        )

        text_input = gr.Textbox(label="Input Text", lines=4, placeholder="Type text to convert to speech...", value=default_text)
